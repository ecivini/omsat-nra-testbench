...
(assert (let ((a!1 (or (<= (- (+ rate_value_c0_10 value_c0_10) 8.0) 0.0)
               trate_value_c0_11)))
  (=> |(increment c0)_11| a!1)))
(assert (let ((a!1 (or (<= (- (+ rate_value_c1_10 value_c1_10) 8.0) 0.0)
               trate_value_c1_11)))
  (=> |(increment c1)_11| a!1)))
(assert (let ((a!1 (or (<= (- (+ rate_value_c2_10 value_c2_10) 8.0) 0.0)
               trate_value_c2_11)))
  (=> |(increment c2)_11| a!1)))
(assert (let ((a!1 (or (<= (- (+ rate_value_c3_10 value_c3_10) 8.0) 0.0)
               trate_value_c3_11)))
