...
(assert (let ((a!1 (or (<= (- (+ rate_value_c0_15 value_c0_15) 10.0) 0.0)
               trate_value_c0_16)))
  (=> |(increment c0)_16| a!1)))
(assert (let ((a!1 (or (<= (- (+ rate_value_c1_15 value_c1_15) 10.0) 0.0)
               trate_value_c1_16)))
  (=> |(increment c1)_16| a!1)))
(assert (let ((a!1 (or (<= (- (+ rate_value_c2_15 value_c2_15) 10.0) 0.0)
               trate_value_c2_16)))
  (=> |(increment c2)_16| a!1)))
(assert (let ((a!1 (or (<= (- (+ rate_value_c3_15 value_c3_15) 10.0) 0.0)
               trate_value_c3_16)))
  (=> |(increment c3)_16| a!1)))
(assert (let ((a!1 (or (<= (- (+ rate_value_c4_15 value_c4_15) 10.0) 0.0)
               trate_value_c4_16)))
