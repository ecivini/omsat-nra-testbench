...
(assert (let ((a!1 (=> |(decrement c1)_15|
               (= |__fv_(decrement c1)_cost_15|
                  (* 1.0 (+ 0.0 rate_value_c1_15)))))
      (a!2 (=> |(decrement c0)_15|
...
(assert (let ((a!1 (or (<= (- (+ rate_value_c0_15 value_c0_15) 4.0) 0.0)
               trate_value_c0_16)))
  (=> |(increment c0)_16| a!1)))
(assert (let ((a!1 (or (<= (- (+ rate_value_c1_15 value_c1_15) 4.0) 0.0)
               trate_value_c1_16)))
