...
(assert (=> (or |(increase_rate c2)_10|
    ...
    (and (or |(increase_rate c2)_0|
         ...
         (or |(increase_rate c2)_9|
             ...
             |(increase_rate c1)_9|
             |(increment c2)_9|))))
(assert (=> (or |(increase_rate c2)_11|
...
(assert (let ((a!1 (+ 0.0 (* (+ (* rate_value_c2_10 rate_value_c2_10) 1.0) value_c2_10)))
      (a!2 (+ 0.0 (* (+ (* rate_value_c1_10 rate_value_c1_10) 1.0) value_c1_10)))
      (a!3 (+ 0.0 (* (+ (* rate_value_c0_10 rate_value_c0_10) 1.0) value_c0_10))))
  (and (=> |(increase_rate c2)_10| (= |__fv_(increase_rate c2)_cost_10| 0.0))
       ...
       (>= |__fv_(increase_rate c0)_cost_10| 0.0)
       (<= |__fv_(increase_rate c0)_cost_10| 0.0)
       (=> |(decrement c2)_10| (= |__fv_(decrement c2)_cost_10| (* 1.0 a!1)))
       (=> (not |(decrement c2)_10|) (= |__fv_(decrement c2)_cost_10| 0.0))
       (>= |__fv_(decrement c2)_cost_10| 0.0)
       (<= |__fv_(decrement c2)_cost_10| (* 1.0 a!1))
       ...
       (=> |(decrement c0)_10| (= |__fv_(decrement c0)_cost_10| (* 1.0 a!3)))
       (=> (not |(decrement c0)_10|) (= |__fv_(decrement c0)_cost_10| 0.0))
       (>= |__fv_(decrement c0)_cost_10| 0.0)
       (<= |__fv_(decrement c0)_cost_10| (* 1.0 a!3))
       ...
       (>= |__fv_(increase_rate c0)_cost_11| 0.0)
       (<= |__fv_(increase_rate c0)_cost_11| 0.0)
       (=> |(decrement c2)_11| (= |__fv_(decrement c2)_cost_11| (* 1.0 a!1)))
       (=> (not |(decrement c2)_11|) (= |__fv_(decrement c2)_cost_11| 0.0))
       (>= |__fv_(decrement c2)_cost_11| 0.0)
       (<= |__fv_(decrement c2)_cost_11| (* 1.0 a!1))
       ...
       (=> |(decrement c0)_11| (= |__fv_(decrement c0)_cost_11| (* 1.0 a!3)))
       (=> (not |(decrement c0)_11|) (= |__fv_(decrement c0)_cost_11| 0.0))
       (>= |__fv_(decrement c0)_cost_11| 0.0)
       (<= |__fv_(decrement c0)_cost_11| (* 1.0 a!3))
...
(assert (let ((a!1 (+ (* (+ (* rate_value_c0_10 rate_value_c0_10) 1.0) value_c0_10)
              value_c0_10)))
  (=> |(increment c0)_11|
      (or (<= (- a!1 6.0) 0.0) trate_value_c0_11 trate_value_c0_11))))
(assert (let ((a!1 (+ (* (+ (* rate_value_c1_10 rate_value_c1_10) 1.0) value_c1_10)
              value_c1_10)))
  (=> |(increment c1)_11|
      (or (<= (- a!1 6.0) 0.0) trate_value_c1_11 trate_value_c1_11))))
(assert (let ((a!1 (+ (* (+ (* rate_value_c2_10 rate_value_c2_10) 1.0) value_c2_10)
              value_c2_10)))
  (=> |(increment c2)_11|
      (or (<= (- a!1 6.0) 0.0) trate_value_c2_11 trate_value_c2_11))))
